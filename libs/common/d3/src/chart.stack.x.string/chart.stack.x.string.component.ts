...
@Component({
  selector: 'ia-chart-stack-x-string',
  templateUrl: './chart.stack.x.string.component.html',
  styleUrls: ['./chart.stack.x.string.component.scss']
})
export class ChartStackXStringComponent implements OnInit, OnChanges {
  @Input()
  options: any = {
